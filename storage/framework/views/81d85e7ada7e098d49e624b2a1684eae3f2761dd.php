...
<?php $component = App\View\Components\Board::resolve(['color' => 'blue-500','name' => 'Doctors','digit' => ''.e(\App\Models\User::count() - 1).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
